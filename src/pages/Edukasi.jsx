        ...
        <div className="bg-surface text-on-surface">
            <section className="relative overflow-hidden pt-32 pb-24 sm:pt-40 sm:pb-36">
                ...
                <div className="relative max-w-7xl mx-auto px-8 text-center space-y-6 z-10">
                    <span className="inline-block px-4 py-1.5 rounded-sm bg-white border border-primary/20 shadow-sm text-primary font-bold tracking-widest uppercase text-xs">
                        {t('edukasi.badge')}
                    </span>
            ...
            <section className="py-10 bg-surface border-t border-outline-variant/10">
                <div className="max-w-4xl mx-auto px-8 text-center space-y-10">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4">
                        <Link
                            to="/"
                            className="w-full sm:w-auto px-6 py-3.5 border-2 border-outline-variant/30 text-primary font-bold rounded-sm hover:border-primary/50 hover:bg-surface-container-low transition-colors duration-300"
                        >
                            {t('edukasi.ctaHome')}
                        </Link>
                        ...
                        <Link
                            to="/contact"
                            className="w-full sm:w-auto px-6 py-3.5 bg-secondary text-white font-bold rounded-sm hover:bg-[#a65d00] transition-colors duration-300 shadow-md hover:shadow-lg"
                        >
                            {t('edukasi.ctaTech')}
                        </Link>
                        ...
                        <a
                            ...
                            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-r from-[#20B038] to-[#25D366] text-white font-bold rounded-sm hover:shadow-lg hover:shadow-[#25D366]/40 transition-all duration-300"
                        >
