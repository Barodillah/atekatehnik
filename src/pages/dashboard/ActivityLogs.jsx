  ...
  return (
    <div className="p-8 space-y-8 flex-1 flex flex-col">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h2 className="text-3xl font-extrabold text-blue-950 tracking-tight font-headline">Activity Logs</h2>
          <p className="text-slate-500 font-body">System-wide audit trail for users and automated events.</p>
        </div>
        <div className="flex items-center gap-3">
          <span className="text-sm font-bold text-slate-400">Total: {total} Logs</span>
          <button onClick={fetchLogs} className="bg-white border border-slate-200 text-slate-600 px-4 py-2 rounded-sm font-bold text-xs hover:bg-slate-50 transition-colors flex items-center gap-2">
