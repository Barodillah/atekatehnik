                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-3 mt-2">
                                            <a href="https://wa.me/62881080634612?text=Saya%20melihat%20dari%20website%20atekatehnik.com.%20Halo%20Ateka%20Tehnik." target="_blank" rel="noopener noreferrer" onClick={() => trackWaClick('contact-page', 'wa-support')} className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#25D366] hover:underline">
