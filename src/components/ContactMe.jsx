  ...
  return (
    <section className="py-20 md:py-32 relative overflow-hidden bg-surface">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white/60 backdrop-blur-3xl p-6 sm:p-10 lg:p-14 rounded-sm shadow-2xl shadow-primary/5 ring-1 ring-primary/10 relative overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-10 md:gap-14 items-center">
            ...
            <div className="order-1 flex flex-col justify-center space-y-8">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-sm bg-primary/10 text-primary font-bold text-xs tracking-widest uppercase mb-4 shadow-sm border border-primary/20">
              ...
              <div className="space-y-4">
                {/* Location Card */}
                <div className="group flex items-start gap-5 p-5 bg-white rounded-sm shadow-sm border border-outline-variant/20 hover:shadow-md hover:border-primary/30 transition-all duration-300">
                  <div className="flex-shrink-0 w-12 h-12 bg-primary/10 rounded-sm flex items-center justify-center text-primary group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                ...
                {/* Phone Card */}
                <a href="tel:+62881080634612" className="group flex items-start gap-5 p-5 bg-white rounded-sm shadow-sm border border-outline-variant/20 hover:shadow-md hover:border-primary/30 transition-all duration-300 cursor-pointer">
                  <div className="flex-shrink-0 w-12 h-12 bg-secondary/10 rounded-sm flex items-center justify-center text-secondary group-hover:scale-110 group-hover:bg-secondary group-hover:text-white transition-all duration-300">
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center">
                <a
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-[#20B038] to-[#25D366] text-white rounded-sm font-bold flex items-center justify-center gap-2.5 hover:shadow-lg hover:shadow-[#25D366]/40 hover:-translate-y-1 transition-all duration-300"
                >
                ...
                <Link
                  to="/contact"
                  className="w-full sm:w-auto px-8 py-4 bg-white text-primary rounded-sm font-bold flex items-center justify-center gap-2 hover:bg-surface-container-low transition-colors duration-300 shadow-sm border border-outline-variant/30 group"
                >
            ...
            {/* Maps Embed */}
            <div className="order-2 relative w-full h-[350px] lg:h-[500px] rounded-sm overflow-hidden shadow-2xl shadow-primary/10 border-4 border-white/80 group">
              ...
              <div className="absolute bottom-5 right-5 z-20 bg-white/90 backdrop-blur-md px-4 py-2 rounded-sm shadow-lg border border-white flex items-center gap-2 pointer-events-none transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
