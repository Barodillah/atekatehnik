      ...
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://www.facebook.com/warsito.atktehnik" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ffa454] transition-colors" aria-label="Facebook">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://youtube.com/@atekatehnik" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ffa454] transition-colors" aria-label="YouTube">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
